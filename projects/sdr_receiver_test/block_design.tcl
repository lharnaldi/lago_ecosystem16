...
# Create port_slicer
cell labdpr:user:port_slicer slice_8 {
...
cell labdpr:user:axis_constant const_test {
  AXIS_TDATA_WIDTH 32
} {
...
cell labdpr:user:axis_phase_generator phase_test {
  AXIS_TDATA_WIDTH 32
  PHASE_WIDTH 30
} {
...
cell labdpr:user:axis_rp_dac dac_test {
  DAC_DATA_WIDTH 14
} {
  aclk pll_0/clk_out1
...
# Create axis_phase_generator
cell labdpr:user:axis_phase_generator phase_0 {
  AXIS_TDATA_WIDTH 32
  PHASE_WIDTH 30
} {
...
# Create axis_constant
cell labdpr:user:axis_constant rate_0 {
  AXIS_TDATA_WIDTH 16
} {
...
# Create axis_constant
cell labdpr:user:axis_constant rate_1 {
  AXIS_TDATA_WIDTH 16
} {
  cfg_data slice_6/dout
  aclk pll_0/clk_out1
...
# Create axis_packetizer
cell labdpr:user:axis_packetizer pktzr_1 {
  AXIS_TDATA_WIDTH 16
  CNTR_WIDTH 1
  CONTINUOUS FALSE
} {
