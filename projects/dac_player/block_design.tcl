...
# Create axis_rp_adc
cell labdpr:user:axis_rp_adc0 adc_0 {
  ADC_DATA_WIDTH 14
} {
  aclk pll_0/clk_out1
...
for {set i 0} {$i <= 1} {incr i} {
  ...
  cell labdpr:user:axis_variable rate_$i {
    AXIS_TDATA_WIDTH 16
  } {
...
cell labdpr:user:axi_axis_writer writer_1 {
  AXI_DATA_WIDTH 32
} {
  aclk pll_0/clk_out1
  aresetn rst_0/peripheral_aresetn
...
# Create axis_zeroer
cell labdpr:user:axis_zeroer zeroer_0 {
  AXIS_TDATA_WIDTH 32
} {
...
for {set i 0} {$i <= 1} {incr i} {
  ...
  # Create axis_variable
  cell labdpr:user:axis_variable rate_[expr $i + 2] {
    AXIS_TDATA_WIDTH 16
  } {
