...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_2 {
...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_3 {
...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_4 {
...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_5 {
...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_6 {
...
# Create port_slicer
cell labdpr:user:port_slicer:1.0 slice_7 {
