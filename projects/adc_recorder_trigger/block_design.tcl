...
cell labdpr:user:axis_gpio_reader gpio_0 {
  AXIS_TDATA_WIDTH 8
} {
...
# Create axis_variable
cell labdpr:user:axis_variable rate_1 {
  AXIS_TDATA_WIDTH 16
} {
  cfg_data slice_8/dout
  aclk pll_0/clk_out1
...
# Create axis_trigger
cell labdpr:user:axis_trigger trig_0 {
  AXIS_TDATA_WIDTH 8
...
cell labdpr:user:axis_oscilloscope scope_0 {
  AXIS_TDATA_WIDTH 32
  CNTR_WIDTH 23
} {
