...
//o mostrar resultados en algun tipo de aplicacion grafica (Labview o algun applet)
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <string.h>
...
int main(int argc, char * argv []){
				int fd;
				void *map_base, *virt_addr, *map_base_thread, *virt_addr_thread;
				//unsigned long read_result, writeval;
				//off_t target;
				// int access_type
				fd = open("/dev/uio0", O_RDWR | O_SYNC); //Abrimos toda la memoria fisica del Xilinx
				printf("%d",fd);
